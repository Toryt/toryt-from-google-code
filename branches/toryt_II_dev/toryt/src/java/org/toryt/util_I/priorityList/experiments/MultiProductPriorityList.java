 ...
 */
public class MultiProductPriorityList
   ...
   */
  public MultiProductPriorityList(PriorityList[] priorityLists) {
    ...
    $ppl = new ProductPriorityList(priorityLists[priorityLists.length - 2],
                                   priorityLists[priorityLists.length - 1]);
    for (int i = priorityLists.length - 3; i >= 0; i--) {
      $ppl = new ProductPriorityList(priorityLists[i], $ppl);
    }
  }
  ...
  private class MX_PLI extends AbstractPriorityListIterator {
    ...
    public MX_PLI() {
      super(MultiProductPriorityList.this);
