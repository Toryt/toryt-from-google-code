...
@CvsInfo(revision = "$Revision$",
         ...
         state    = "$State$",
         tag      = "$Name$")
public class BiArrayProductPriorityList extends AbstractLazyLockedComponentPriorityList {

  private BiArrayProductPriorityList(PriorityList leftFactor, PriorityList rightFactor, int fromIndex, int toIndex) {
  ...
  public BiArrayProductPriorityList(PriorityList leftFactor, PriorityList rightFactor) {
  ...
  public final List subList(int fromIndex, int toIndex) {
    return new BiArrayProductPriorityList($leftFactor, $rightFactor, fromIndex, toIndex);
  }
