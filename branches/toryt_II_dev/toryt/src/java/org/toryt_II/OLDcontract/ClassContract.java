...
/**
 * The contract of a class. A {@link HardTypeContract} for types that
 * are not interfaces.
 * 
 ...
 *            o instanceof HardConstructorContract);
 * @invar (forall HardConstructorContract cc; getConstructorContracts().contains(cc);
