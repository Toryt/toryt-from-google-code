...
public class Contracts {
  ...
  public static TypeContract typeContractInstance(Class type)
    ...
    if (tc == null) {
      ...
      tc = (TypeContract)Beans.instantiatePrefixed(cl, TYPE_CONTRACT_NAME_PREFIX, cn);
...
//  public static final String PACKAGE_CONTRACT_CLASS_NAME = "_Package_Contract_";
  ...
  public static PackageContract packageContractInstance(String packageName,
    ...
    if (pc == null) {
//    pc = (PackageContract)java.beans.Beans.instantiate(Contracts.class.getClassLoader(),
//    packageName + "." + PACKAGE_CONTRACT_CLASS_NAME);
      org.toryt.hard.PackageContract hPc
          = new org.toryt.hard.PackageContract(Package.getPackage(packageName));
